...
It's possible that you want the two things different. For me, my site-title is **“hua Blog”** but I want the title shows in search engine is **“张华的博客 | hua Blog”** which is multi-language.
