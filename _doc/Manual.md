...
```yml
# Site settings
title: hua Blog             # title of your website
SEOTitle: hua Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: huapro     # modify this account to yours
weibo_username: huapro      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-hua.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“hua Blog”** but I want the title shows in search engine is **“黄玄的博客 | hua Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/huapro/huapro.github.io/issues/15) about code wrap.
